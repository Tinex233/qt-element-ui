...
{
    _msgManager = new MessageManager(ui->tabWidget);
    ...
    connect(ui->button_43, &Button::clicked, this, [&]() {
        Message* message = new Message( "This is a message.", " VNode", _msgManager, this);
        message->setType(Message::Type::Info);
        message->show();
    });
    connect(ui->button_44, &Button::clicked, this, [&]() {
        Message* message = new Message("This is a message on top left.", _msgManager, this);
        message->setPlacement(Message::Place::TopLeft);
        message->show();
    });
    connect(ui->button_45, &Button::clicked, this, [&]() {
        Message* message = new Message("This is a message on top right.", _msgManager, this);
        message->setPlacement(Message::Place::TopRight);
        message->show();
    });
    connect(ui->button_46, &Button::clicked, this, [&]() {
        Message* message = new Message("This is a message on bottom.", _msgManager, this);
        message->setPlacement(Message::Place::Bottom);
        message->show();
    });
    connect(ui->button_47, &Button::clicked, this, [&]() {
        Message* message = new Message("This is a message on bottom left.", _msgManager,  this);
        message->setPlacement(Message::Place::BottomLeft);
        message->show();
    });
    connect(ui->button_48, &Button::clicked, this, [&]() {
        Message* message = new Message("This is a message on bottom right.", _msgManager, this);
        message->setPlacement(Message::Place::BottomRight);
        message->show();
    });
    connect(ui->button_49, &Button::clicked, this, [&]() {
        Message* message = new Message("This is a primary message.", Message::Type::Primary, _msgManager, this);
        message->show();
    });
    connect(ui->button_50, &Button::clicked, this, [&]() {
        Message* message = new Message("This is a success message.", Message::Type::Success, _msgManager, this);
        message->show();
    });
    connect(ui->button_51, &Button::clicked, this, [&]() {
        Message* message = new Message("This is a warning message.", Message::Type::Warning, _msgManager, this);
        message->show();
    });
    connect(ui->button_52, &Button::clicked, this, [&]() {
        Message* message = new Message("This is a info message.", Message::Type::Info, _msgManager, this);
        message->show();
    });
    connect(ui->button_53, &Button::clicked, this, [&]() {
        Message* message = new Message("This is a error message.", Message::Type::Error, _msgManager, this);
        message->show();
    });

    //带回调函数
    connect(ui->button_65, &Button::clicked, this, [&]() {
        Message* message = new Message("Terminal output a message.", _msgManager, this);
    ...
    //为单条Message定制，无需传入MessageManager
    connect(ui->button_66, &Button::clicked, this, [&]() {
        Message* message = new Message( "This is a independent message.", nullptr, this);
        message->move(ui->tabWidget->width()/2, ui->tabWidget->height()/2);
        message->show();
    });
