...
namespace Element
{
    Message::Message(const QString& message, MessageManager* manager, QWidget* parent)
        : Message(message, "", Type::Info, manager, parent)
    {}

    Message::Message(const QString& message, const QString& paramater, MessageManager* manager, QWidget* parent)
        : Message(message, paramater, Type::Info, manager,  parent)
    {}

    Message::Message(const QString& message, Message::Type type, MessageManager* manager, QWidget* parent)
        : Message(message, "", type, manager, parent)
    {}

    Message::Message(const QString& message, const QString& paramater, Type type, MessageManager* manager, QWidget* parent)
        : QWidget(parent)
        , _message(message)
